...
QT_MOC_LITERAL(1, 6, 15), // "familiesChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8) // "families"

    },
    "Fonts\0familiesChanged\0\0families"
};
...
void Fonts::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->familiesChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (Fonts::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Fonts::familiesChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = _t->families(); break;
        default: break;
        }
